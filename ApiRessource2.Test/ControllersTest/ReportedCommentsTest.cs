...
{
    public class ReportedCommentsTest : IDisposable
    {
        private readonly DataContext _context;
        private readonly ReportedCommentsController _controller;


        public ReportedCommentsTest()
        {
            ...
            _controller = new ReportedCommentsController(_context);
        }
